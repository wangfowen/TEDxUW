...
ComfortableMexicanSofa.configure do |config|
  ...
  config.upload_file_options = { storage: :s3, s3_credentials: "#{Rails.root}/config/fog.yml", s3_host_name: "s3.amazonaws.com" }
...
ComfortableMexicanSofa::HttpAuth.username = 'tedxuw'
ComfortableMexicanSofa::HttpAuth.password = 'TEDxUW2014'
